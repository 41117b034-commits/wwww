...
public class Chapter1PerformanceController : MonoBehaviour
{
    ...
    private void EnsureWeddingCrowdDancers()
    {
        ...
        for (int i = 0; i < animators.Length; i++)
        {
            ...
            // Procedural limb motion is only safe on a validated Humanoid avatar.
            // Generic rigs keep their authored pose so meshes cannot separate.
...
/// Humanoid validation keeps custom or Generic rigs untouched.
/// </summary>
...
public sealed class Chapter1WeddingLimbDance : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        Vector3 bodyForward = Vector3.Cross(bodyUp, bodyRight);
